...
function (_Component) {
  ...
  function cfiApp(props) {
    ...
    _this.handleCategorySelect = _this.handleCategorySelect.bind(_assertThisInitialized(_this));
    ...
    _this.loadCategoryData = _this.loadCategoryData.bind(_assertThisInitialized(_this));
    return _this;
  ...
  _createClass(cfiApp, [{
    ...
    value: function handleCategorySelect(event) {
      var _this2 = this;
      ...
      if (event.target.value === 'none') {
        ...
        this.setState({
          ...
          _this2.loadCategoryData(_this2.state.currentPost);
        });
      }
    } // Update state when a category is selected
    ...
    value: function loadCategoryData(post_id) {
      var that = this; // First we update the state, this displays the image to the user
    ...
    value: function render() {
      var _this$state = this.state,
          ...
          activeCategoryData = _this$state.activeCategoryData,
          categorySelectData = _this$state.categorySelectData,
      ...
      return React.createElement("div", {
        ...
        id: "cfiConditions"
      }, React.createElement("p", null, React.createElement("strong", null, "Select a category")), React.createElement("select", {
        value: activeCategory,
        className: "form-control",
        onChange: this.handleCategorySelect
      }, React.createElement("option", {
        value: "none"
      }, "-- Select Category --"), categorySelectData.map(function (category) {
      ...
      }, React.createElement("small", null, "If you don't see any categories listed, make sure to first assign this post to a category, and then update the post and/or refresh the page to see the category in the dropdown."))), React.createElement("div", {
        id: "cfiMedia"
        ...
        className: "upload-custom-img components-button is-button is-default",
        id: "cfi_upload_img_btn",
        onClick: this.handleSetImageClick
      }, hasCustomImage ? 'Replace image' : 'Set custom image'), React.createElement("button", {
        className: "delete-custom-img components-button is-link is-destructive",
        ...
        name: "cfi_meta_key",
        type: "hidden",
        value: '_cfi_catch_' + activeCategory
        ...
        type: "hidden",
        value: ""
      })) : React.createElement("p", null, React.createElement("em", null, "Select a category first...")))));
    }
  }]);
...
__webpack_require__(/*! /Users/zachary/Sites/plugins-dev/app/public/wp-content/plugins/contextual-featured-images/assets/js/admin/cfi-admin.js */"./assets/js/admin/cfi-admin.js");
module.exports = __webpack_require__(/*! /Users/zachary/Sites/plugins-dev/app/public/wp-content/plugins/contextual-featured-images/assets/css/cfi-admin.scss */"./assets/css/cfi-admin.scss");
